...
- **Panel modal** (`#modal-backdrop` → `.panel-modal.modal--wide`) — jeden szeroki modal: Scenariusz, Decyzja, Historia, Startup / status, Zasoby, Growbox, Safety (zakładki w `modal-head`)
