...
public:
  explicit ScriptedInputSource(std::vector<ScriptedFrame> frames) : frames_(std::move(frames)) {}
...
public:
  explicit ScriptedActuatorSink(std::vector<bool> outcomes = {}) : outcomes_(std::move(outcomes)) {}
...
void testStatefulRuleSequenceUpdatesTrendsAndEffectiveState() {
  ScriptedInputSource source(
      {{true, inputFor(20.0F)}, {true, inputFor(21.0F)}, {true, inputFor(22.0F)}});
...
void testStaleAndUnavailableInputsFailClosedThenRecover() {
  ...
  ScriptedInputSource source(
      {{true, inputFor(20.0F)}, {true, stale}, {false, {}}, {true, inputFor(20.0F)}});
  ScriptedActuatorSink sink{};
