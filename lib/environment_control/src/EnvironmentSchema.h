...
inline constexpr std::size_t kFeatureCount = 40U;
...
enum class FeatureIndex : std::size_t {
    ...
    HumidifierAvailable = 26,
    HumidifierMaxOutputGH = 27,
    IrrigationAvailable = 28,
    IrrigationFlowMlS = 29,
    IrrigationMaximumPulseS = 30,
    IrrigationMinimumIntervalS = 31,
    TargetAirTemperatureC = 32,
    TargetAirHumidityPct = 33,
    TargetCo2Ppm = 34,
    TargetSoilMoisturePct = 35,
    PreviousHeater = 36,
    PreviousFan = 37,
    PreviousHumidifier = 38,
    PreviousIrrigation = 39,
};
