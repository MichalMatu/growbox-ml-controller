...
wrapper_dir = Path(tempfile.mkdtemp(prefix="a13-2-v5-bin-"))
...
worktree = Path(tempfile.mkdtemp(prefix="growbox-a13-2-v5-qualified-"))
worktree.rmdir()
try:
    ...
    build_dir = worktree / "build/idf-a13-2-v5-qualified-real"
