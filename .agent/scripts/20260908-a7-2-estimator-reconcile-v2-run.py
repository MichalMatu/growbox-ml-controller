...
print('A7_2_V2_IDENTITY_PASS', flush=True)
...
print('A7_2_V2_STATIC_PASS', flush=True)

build = 'build/host-tests-a7-2-v2'
targets = [
    'climate_v6_tests',
...
print('A7_2_V2_FOCUSED_PASS', flush=True)
...
assert not subprocess.check_output('git status --porcelain', shell=True, text=True).strip()
print(f'A7_2_V2_PASS commit={new}', flush=True)
