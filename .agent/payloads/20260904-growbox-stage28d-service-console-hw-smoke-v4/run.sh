...
EXPECTED=af16aebde8f69d1a1257256c7711e9721c07c9d5
...
export STAGE27C_BUILD_DIR=build/idf-stage28d-service-console-hw-smoke-v4
...
Path("/tmp/stage28d_service_console_hw_smoke_v4.log").write_text(text)
print(text[-16000:])
...
print(
    "STAGE28D_SERVICE_CONSOLE_HW_SMOKE_V4_PASS "
