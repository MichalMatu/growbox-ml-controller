...
from tools.ml.climate_policy import ClimateRulePolicy, apply_climate_safety, arbitrate_climate_action
...
Path("tools/ml/climate_runtime.py").write_text(runtime, encoding="utf-8")
Path("tests/test_climate_runtime.py").write_text(tests, encoding="utf-8")
