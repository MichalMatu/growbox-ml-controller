...
#define GROWBOX_STAGE28E_LOG_ERROR(module, ...)                                                    \
  do {                                                                                             \
    ::growbox::app::climate_io::runtime::stage28eLogWrite(                                         \
        (module), ::growbox::app::climate_io::runtime::DiagnosticLogLevel::Error, __VA_ARGS__);    \
  } while (0)
#else
#define GROWBOX_STAGE28E_LOG_ERROR(module, ...)                                                    \
  do {                                                                                             \
...
#define GROWBOX_STAGE28E_LOG_WARN(module, ...)                                                     \
  do {                                                                                             \
    ::growbox::app::climate_io::runtime::stage28eLogWrite(                                         \
        (module), ::growbox::app::climate_io::runtime::DiagnosticLogLevel::Warn, __VA_ARGS__);     \
  } while (0)
#else
#define GROWBOX_STAGE28E_LOG_WARN(module, ...)                                                     \
  do {                                                                                             \
...
#define GROWBOX_STAGE28E_LOG_INFO(module, ...)                                                     \
  do {                                                                                             \
    ::growbox::app::climate_io::runtime::stage28eLogWrite(                                         \
        (module), ::growbox::app::climate_io::runtime::DiagnosticLogLevel::Info, __VA_ARGS__);     \
  } while (0)
#else
#define GROWBOX_STAGE28E_LOG_INFO(module, ...)                                                     \
  do {                                                                                             \
...
#define GROWBOX_STAGE28E_LOG_DEBUG(module, ...)                                                    \
  do {                                                                                             \
    ::growbox::app::climate_io::runtime::stage28eLogWrite(                                         \
        (module), ::growbox::app::climate_io::runtime::DiagnosticLogLevel::Debug, __VA_ARGS__);    \
  } while (0)
#else
#define GROWBOX_STAGE28E_LOG_DEBUG(module, ...)                                                    \
  do {                                                                                             \
...
#define GROWBOX_STAGE28E_LOG_TRACE(module, ...)                                                    \
  do {                                                                                             \
    ::growbox::app::climate_io::runtime::stage28eLogWrite(                                         \
        (module), ::growbox::app::climate_io::runtime::DiagnosticLogLevel::Trace, __VA_ARGS__);    \
  } while (0)
#else
#define GROWBOX_STAGE28E_LOG_TRACE(module, ...)                                                    \
  do {                                                                                             \
