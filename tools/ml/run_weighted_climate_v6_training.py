...
def _strong_ratio_report(
    dataset: Dataset, predictions: np.ndarray, strong_threshold: float
...
def main() -> None:
    ...
    print(
        f"STAGE9C_VALIDATION_CONTROL_IMPROVEMENT={validation_improvement:.6f}",
        flush=True,
    )
