...
const HELP_TOPICS = {
  app: {
    ...
    html: `
      ...
      <ul>
        ...
        <li><strong>Poprzedni</strong> — modal: ostatnie wyjścia aktuatorów (tylko odczyt), uzupełniane po <strong>Krok</strong> z Safety</li>
      </ul>
    `,
  },
  sensors: {
  ...
  previous: {
    ...
    html: `
      ...
      <p>Przycisk <strong>Poprzedni</strong> pod <strong>Na żywo</strong> (panel modal). Tabela tylko do odczytu. Po <strong>Krok</strong> wartości uzupełniają się z ostatnich wyjść <strong>Safety</strong> (kontekst modelu na następny krok).</p>
    `,
  },
  ...
  live: {
    ...
    html: `
      ...
      <p><strong>Scenariusz</strong>, <strong>Decyzja</strong>, <strong>Historia</strong>, <strong>Status</strong>, <strong>Poprzedni</strong>, <strong>Zasoby</strong>, <strong>Growbox</strong>, <strong>Safety</strong> — jeden przesuwalny modal; przełącz widok przyciskami pod <strong>Na żywo</strong> (aktywny podświetlony). Zamknij: <strong>Zamknij</strong> w nagłówku lub <strong>Esc</strong>.</p>
    `,
  },
};
...
const FIELD_HINTS = {
  ...
  nutrient_solution_temperature_c: "Temperatura roztworu nawozu w zbiorniku (wejście ML)",
  soil_moisture_pct: "Wilgotność podłoża w doniczce (wejście ML)",
  soil_temperature_c: "Temperatura gleby w doniczce (wejście ML)",
  ...
  dehumidifier_available: "Osuszacz w zestawie — odznaczone = wyjście zawsze 0 po wysłaniu",
  dehumidifier_max_removal_g_h: "Maks. wydajność osuszacza (g/h)",
  cooler_available: "Chłodzenie w zestawie — odznaczone = wyjście zawsze 0 po wysłaniu",
  cooler_max_cooling_w: "Maks. moc chłodzenia (W)",
  co2_doser_available: "Dozownik CO₂ w zestawie — odznaczone = wyjście zawsze 0 po wysłaniu",
  ...
  co2_doser_dose_ppm_per_full_pulse: "Przyrost CO₂ (ppm) na jeden pełny impuls dozownika",
  ...
  previous_heater: "Poprzednie wyjście grzałki (0–1) — kontekst modelu ML",
  previous_fan: "Poprzednie wyjście wentylatora (0–1)",
  previous_humidifier: "Poprzednie wyjście nawilżacza (0–1)",
